...
format:
  revealjs:
    ...
    title-slide-attributes:
      data-background-image: img/qr.svg
      data-background-size: 140px 140px
      data-background-position: "bottom 32px left calc(50% + 5px)"
...
## Thank you! {.part-gradient background-image="img/qr.svg" background-size="140px 140px" background-position="bottom 32px right 40px" background-repeat="no-repeat"}
